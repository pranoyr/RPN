...
class RoIHeads(torch.nn.Module):
	...
	def select_training_samples(self,
		...
		# matched_idxs, labels = self.assign_targets_to_proposals(proposals, gt_boxes, gt_labels, assign_to="subject")
		# sampled_inds = self.subsample(labels)   			#	size 64 --> 32 pos, 32 neg
		# sub_proposals = proposals.copy()
		# sub_matched_idxs = matched_idxs.copy()
		...
		# 	sub_labels[img_id] = labels[img_id][img_sampled_inds]
		# 	sub_matched_idxs[img_id] = matched_idxs[img_id][img_sampled_inds]
		...
		# 	obj_labels[img_id] = labels[img_id][img_sampled_inds]
		# 	obj_matched_idxs[img_id] = matched_idxs[img_id][img_sampled_inds]
		...
		# 	regression_targets.append(torch.cat([obj_regression_targets[i],obj_regression_targets[i]]))
