...
def reldn_so_losses(sbj_cls_scores, obj_cls_scores, sbj_labels_int32, obj_labels_int32):
    ...
    sbj_labels = Variable(torch.from_numpy(sbj_labels_int32.astype('int64'))).to(device)
    ...
    obj_labels = Variable(torch.from_numpy(obj_labels_int32.astype('int64'))).to(device)
